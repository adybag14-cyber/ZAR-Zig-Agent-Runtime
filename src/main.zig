...
test "baremetal abi module exposes expected v2 contract constants" {
    ...
    try std.testing.expect((baremetal_abi.defaultFeatureFlags() & baremetal_abi.feature_health_history_export) != 0);
    try std.testing.expect((baremetal_abi.defaultAbiFlags() & baremetal_abi.kernel_abi_health_history) != 0);
    try std.testing.expect((baremetal_abi.defaultFeatureFlags() & baremetal_abi.feature_mode_history_export) != 0);
    try std.testing.expect((baremetal_abi.defaultAbiFlags() & baremetal_abi.kernel_abi_mode_history) != 0);
    try std.testing.expect((baremetal_abi.defaultFeatureFlags() & baremetal_abi.feature_boot_phase_history_export) != 0);
    try std.testing.expect((baremetal_abi.defaultAbiFlags() & baremetal_abi.kernel_abi_boot_phase_history) != 0);
    try std.testing.expect((baremetal_abi.defaultFeatureFlags() & baremetal_abi.feature_command_result_counters_export) != 0);
    try std.testing.expect((baremetal_abi.defaultAbiFlags() & baremetal_abi.kernel_abi_command_result_counters) != 0);
    try std.testing.expect((baremetal_abi.defaultFeatureFlags() & baremetal_abi.feature_scheduler_export) != 0);
    try std.testing.expect((baremetal_abi.defaultAbiFlags() & baremetal_abi.kernel_abi_scheduler) != 0);
    try std.testing.expect((baremetal_abi.defaultFeatureFlags() & baremetal_abi.feature_allocator_export) != 0);
    try std.testing.expect((baremetal_abi.defaultAbiFlags() & baremetal_abi.kernel_abi_allocator) != 0);
    try std.testing.expect((baremetal_abi.defaultFeatureFlags() & baremetal_abi.feature_syscall_table_export) != 0);
    try std.testing.expect((baremetal_abi.defaultAbiFlags() & baremetal_abi.kernel_abi_syscall_table) != 0);
    try std.testing.expect((baremetal_abi.defaultFeatureFlags() & baremetal_abi.feature_interrupt_mask_export) != 0);
    try std.testing.expect((baremetal_abi.defaultAbiFlags() & baremetal_abi.kernel_abi_interrupt_mask) != 0);
}
...
test "baremetal x86 bootstrap module exports descriptor table metadata" {
    ...
    baremetal_x86_bootstrap.oc_interrupt_mask_clear_all();
