...
- [x] `zig build`
- [x] `zig build test`
- [x] `zig build test --summary all` -> `89/89` passing (includes gateway auth/rate-limit hardening tests, TTS/completion execution-path coverage, and bare-metal ABI v2 contract tests)
