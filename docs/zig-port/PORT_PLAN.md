...
- `FS5.7` i386 CPU-architecture support is now tracked in:
  ...
  - current boundary is explicit: this is boot/build smoke plus the first broad real i386 storage/NIC/display/service lanes, not full 32-bit driver/runtime parity; remaining gaps are now routed RTL8139 proof, broader display/profile/output parity, and higher-level runtime/package/workspace/app depth on i386
