...
- host regressions now prove bounded TTY open/write/pending/send/clear/events/read/stdout/stderr/close behavior plus `tty-shell`, shell transcript/event receipts, and `/dev` and `/sys` TTY readback
