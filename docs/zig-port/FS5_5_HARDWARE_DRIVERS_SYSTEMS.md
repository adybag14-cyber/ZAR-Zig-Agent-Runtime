...
- a second clean-room NIC family now exists for broader FS5.5 depth:
  ...
  - `scripts/baremetal-qemu-e1000-probe-check.ps1`, `scripts/baremetal-qemu-e1000-arp-probe-check.ps1`, `scripts/baremetal-qemu-e1000-ipv4-probe-check.ps1`, `scripts/baremetal-qemu-e1000-udp-probe-check.ps1`, `scripts/baremetal-qemu-e1000-tcp-probe-check.ps1`, and `scripts/baremetal-qemu-e1000-tool-service-probe-check.ps1` now prove live QEMU `E1000` raw-frame, `ARP`, `IPv4`, `UDP`, bounded `TCP`, and framed tool-service reuse behavior over the freestanding PVH artifact
