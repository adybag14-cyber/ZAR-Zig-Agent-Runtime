...
- Latest local test gate: `zig build test --summary all` -> main `219/219` + bare-metal host `116/116` passing
...
- FS4 security/trust closure is also reached locally; the next hosted-phase hard gate is FS2 provider/channel completion.
