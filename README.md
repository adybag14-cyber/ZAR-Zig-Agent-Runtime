...
- `src/baremetal/ata_pio_disk.zig` now provides a real ATA PIO path with `IDENTIFY`, `READ`, `WRITE`, `FLUSH`, first-partition MBR mounting, and protective-MBR GPT partition mounting
