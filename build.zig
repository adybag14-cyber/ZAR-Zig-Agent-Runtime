...
pub fn build(b: *std.Build) void {
    ...
    const baremetal_virtio_block_fat32_mount_probe = b.option(bool, "baremetal-virtio-block-fat32-mount-probe", "Enable the virtio-block FAT32 read-only mount validation path in the freestanding image") orelse false;
