...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_PERIODIC_TIMER_CLAMP_TELEMETRY_PRESERVE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_PERIODIC_TIMER_CLAMP_TELEMETRY_PRESERVE_PROBE_SOURCE' `
