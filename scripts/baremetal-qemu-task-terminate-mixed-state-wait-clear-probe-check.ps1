...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_TASK_TERMINATE_MIXED_STATE_WAIT_CLEAR_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_TASK_TERMINATE_MIXED_STATE_WAIT_CLEAR_PROBE_SOURCE' `
