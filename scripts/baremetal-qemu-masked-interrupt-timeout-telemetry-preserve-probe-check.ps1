...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_MASKED_INTERRUPT_TIMEOUT_TELEMETRY_PRESERVE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_MASKED_INTERRUPT_TIMEOUT_TELEMETRY_PRESERVE_PROBE_SOURCE' `
