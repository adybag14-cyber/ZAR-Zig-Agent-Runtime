...
$stdoutPath = Join-Path $releaseDir 'qemu-e1000-arp-probe.stdout.log'
$stderrPath = Join-Path $releaseDir 'qemu-e1000-arp-probe.stderr.log'
$echoStdoutPath = Join-Path $releaseDir 'qemu-e1000-arp-echo.stdout.log'
$echoStderrPath = Join-Path $releaseDir 'qemu-e1000-arp-echo.stderr.log'
...
pub const e1000_arp_probe: bool = true;
