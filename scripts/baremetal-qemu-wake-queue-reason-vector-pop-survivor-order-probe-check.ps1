...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_WAKE_QUEUE_REASON_VECTOR_POP_SURVIVOR_ORDER_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_WAKE_QUEUE_REASON_VECTOR_POP_SURVIVOR_ORDER_PROBE_SOURCE' `
