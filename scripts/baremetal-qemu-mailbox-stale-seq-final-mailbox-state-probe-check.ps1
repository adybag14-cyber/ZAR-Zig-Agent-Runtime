...
$replayLastOpcode = Extract-Field -BroadText $probeText -RawText $rawText -Name 'REPLAY_LAST_OPCODE'
$replayLastResult = Extract-Field -BroadText $probeText -RawText $rawText -Name 'REPLAY_LAST_RESULT'
