...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_TASK_RESUME_INTERRUPT_TIMEOUT_TELEMETRY_PRESERVE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_TASK_RESUME_INTERRUPT_TIMEOUT_TELEMETRY_PRESERVE_PROBE_SOURCE' `
