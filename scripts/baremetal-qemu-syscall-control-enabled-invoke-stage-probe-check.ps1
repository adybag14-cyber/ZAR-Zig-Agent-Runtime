...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_SYSCALL_CONTROL_ENABLED_INVOKE_STAGE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_SYSCALL_CONTROL_ENABLED_INVOKE_STAGE_PROBE_SOURCE' `
