...
$gdbScript = Join-Path $releaseDir "qemu-scheduler-disable-enable-probe.gdb"
$gdbStdout = Join-Path $releaseDir "qemu-scheduler-disable-enable-probe.gdb.stdout.log"
$gdbStderr = Join-Path $releaseDir "qemu-scheduler-disable-enable-probe.gdb.stderr.log"
$qemuStdout = Join-Path $releaseDir "qemu-scheduler-disable-enable-probe.qemu.stdout.log"
$qemuStderr = Join-Path $releaseDir "qemu-scheduler-disable-enable-probe.qemu.stderr.log"
...
function Invoke-SchedulerArtifactBuildIfNeeded {
    if ($SkipBuild -and -not (Test-Path $artifact)) { throw "Scheduler disable/enable prerequisite artifact not found at $artifact and -SkipBuild was supplied." }
    if ($SkipBuild) { return }
...
if ($null -eq $qemu) {
    ...
    Write-Output "BAREMETAL_QEMU_SCHEDULER_DISABLE_ENABLE_PROBE=skipped"
    exit 0
}
if ($null -eq $gdb) {
...
if $stage == 3
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 3 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__) == 1 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK_RUN_COUNT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_REMAINING_OFFSET__) == 4
    set $dispatch_before_disable = *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__)
    printf "PRE_ENABLED=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__)
    printf "PRE_DISPATCH_COUNT=%llu\n", $dispatch_before_disable
...
if $stage == 4
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 4 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__) == 0 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_RUNNING_SLOT_OFFSET__) == __SCHEDULER_NO_SLOT__ && *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__) == $dispatch_before_disable && *(unsigned int*)(0x__TASKS__+__TASK_RUN_COUNT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_REMAINING_OFFSET__) == 4
    printf "DISABLED_ENABLED=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__)
    printf "DISABLED_RUNNING_SLOT=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_RUNNING_SLOT_OFFSET__)
    printf "DISABLED_DISPATCH_COUNT=%llu\n", *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__)
    printf "DISABLED_RUN_COUNT=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_RUN_COUNT_OFFSET__)
    printf "DISABLED_BUDGET_REMAINING=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_REMAINING_OFFSET__)
    set $stage = 5
  end
  continue
end
if $stage == 5
  if *(unsigned long long*)(0x__STATUS__+__STATUS_TICKS_OFFSET__) >= 5 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__) == 0 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_RUNNING_SLOT_OFFSET__) == __SCHEDULER_NO_SLOT__ && *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__) == $dispatch_before_disable && *(unsigned int*)(0x__TASKS__+__TASK_RUN_COUNT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_REMAINING_OFFSET__) == 4
    printf "IDLE_DISABLED_TICKS=%llu\n", *(unsigned long long*)(0x__STATUS__+__STATUS_TICKS_OFFSET__)
    printf "IDLE_DISABLED_DISPATCH_COUNT=%llu\n", *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__)
    printf "IDLE_DISABLED_RUN_COUNT=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_RUN_COUNT_OFFSET__)
    printf "IDLE_DISABLED_BUDGET_REMAINING=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_REMAINING_OFFSET__)
    set *(unsigned short*)(0x__COMMAND_MAILBOX__+__COMMAND_OPCODE_OFFSET__) = __SCHEDULER_ENABLE_OPCODE__
...
if $stage == 6
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 5 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__) == 1 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_RUNNING_SLOT_OFFSET__) == 0 && *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__) == ($dispatch_before_disable + 1) && *(unsigned int*)(0x__TASKS__+__TASK_RUN_COUNT_OFFSET__) == 2 && *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_REMAINING_OFFSET__) == 3
    printf "HIT_AFTER_SCHEDULER_DISABLE_ENABLE_PROBE\n"
...
try {
    ...
    if (-not $gdbProcess.WaitForExit($TimeoutSeconds * 1000)) {
        ...
        throw "Timed out waiting for GDB scheduler disable/enable probe"
    }
    ...
    if ($gdbExitCode -ne 0) {
        throw "GDB scheduler disable/enable probe failed with exit code $gdbExitCode. stdout: $gdbOutput stderr: $gdbError"
    }

    foreach ($requiredMarker in @("HIT_START", "HIT_AFTER_SCHEDULER_DISABLE_ENABLE_PROBE")) {
    ...
    $expectations = @{
        "PRE_ENABLED" = 1
        "PRE_DISPATCH_COUNT" = 1
        "PRE_RUN_COUNT" = 1
        "PRE_BUDGET_REMAINING" = 4
        "DISABLED_ENABLED" = 0
        "DISABLED_RUNNING_SLOT" = $schedulerNoSlot
        "DISABLED_DISPATCH_COUNT" = 1
        "DISABLED_RUN_COUNT" = 1
        "DISABLED_BUDGET_REMAINING" = 4
        "IDLE_DISABLED_DISPATCH_COUNT" = 1
        "IDLE_DISABLED_RUN_COUNT" = 1
        "IDLE_DISABLED_BUDGET_REMAINING" = 4
        "ACK" = 5
    ...
    if ($null -eq $ticks -or $ticks -lt 5) {
        throw "Unexpected TICKS value. Expected at least 5, got $ticks. stdout: $gdbOutput stderr: $gdbError"
    }

    $idleTicks = Extract-IntValue -Text $gdbOutput -Name "IDLE_DISABLED_TICKS"
    if ($null -eq $idleTicks -or $idleTicks -lt 5) {
        throw "Unexpected IDLE_DISABLED_TICKS value. Expected at least 5, got $idleTicks. stdout: $gdbOutput stderr: $gdbError"
    }
    ...
    Write-Output "BAREMETAL_GDB_BINARY=$gdb"
    Write-Output "BAREMETAL_NM_BINARY=$nm"
    Write-Output "BAREMETAL_QEMU_SCHEDULER_DISABLE_ENABLE_PROBE=pass"
    $gdbOutput.TrimEnd()
} finally {
