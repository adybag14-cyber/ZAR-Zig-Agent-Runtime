...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_DELIVERY_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_DELIVERY_PROBE_SOURCE' `
...
Write-Output 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_DELIVERY_PROBE=pass'
Write-Output 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_DELIVERY_PROBE_SOURCE=baremetal-qemu-interrupt-mask-exception-probe-check.ps1'
