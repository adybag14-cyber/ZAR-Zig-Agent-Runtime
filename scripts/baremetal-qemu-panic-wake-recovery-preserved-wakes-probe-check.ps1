...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_PANIC_WAKE_RECOVERY_PRESERVED_WAKES_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_PANIC_WAKE_RECOVERY_PRESERVED_WAKES_PROBE_SOURCE' `
