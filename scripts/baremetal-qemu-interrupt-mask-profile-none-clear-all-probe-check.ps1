...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_PROFILE_NONE_CLEAR_ALL_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_PROFILE_NONE_CLEAR_ALL_PROBE_SOURCE' `
