...
$gdbScript = Join-Path $releaseDir "qemu-active-task-terminate-probe.gdb"
$gdbStdout = Join-Path $releaseDir "qemu-active-task-terminate-probe.gdb.stdout.log"
$gdbStderr = Join-Path $releaseDir "qemu-active-task-terminate-probe.gdb.stderr.log"
$qemuStdout = Join-Path $releaseDir "qemu-active-task-terminate-probe.qemu.stdout.log"
$qemuStderr = Join-Path $releaseDir "qemu-active-task-terminate-probe.qemu.stderr.log"
...
function Invoke-SchedulerArtifactBuildIfNeeded {
    if ($SkipBuild -and -not (Test-Path $artifact)) { throw "Active-task terminate prerequisite artifact not found at $artifact and -SkipBuild was supplied." }
    if ($SkipBuild) { return }
...
if ($null -eq $qemu) {
    ...
    Write-Output "BAREMETAL_QEMU_ACTIVE_TASK_TERMINATE_PROBE=skipped"
    exit 0
}
if ($null -eq $gdb) {
...
if $stage == 4
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 4 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__) == 1
    set *(unsigned short*)(0x__COMMAND_MAILBOX__+__COMMAND_OPCODE_OFFSET__) = __TASK_CREATE_OPCODE__
...
if $stage == 7
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 7 && *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__) == 1 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_RUNNING_SLOT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK0_RUN_COUNT_OFFSET__) == 0 && *(unsigned int*)(0x__TASKS__+__TASK1_RUN_COUNT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK1_BUDGET_REMAINING_OFFSET__) == 5
    printf "PRE_TERMINATE_TASK_COUNT=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__)
    printf "PRE_TERMINATE_RUNNING_SLOT=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_RUNNING_SLOT_OFFSET__)
    printf "PRE_TERMINATE_LOW_RUN=%u\n", *(unsigned int*)(0x__TASKS__+__TASK0_RUN_COUNT_OFFSET__)
    printf "PRE_TERMINATE_HIGH_RUN=%u\n", *(unsigned int*)(0x__TASKS__+__TASK1_RUN_COUNT_OFFSET__)
    printf "PRE_TERMINATE_HIGH_BUDGET_REMAINING=%u\n", *(unsigned int*)(0x__TASKS__+__TASK1_BUDGET_REMAINING_OFFSET__)
    ...
    set *(unsigned long long*)(0x__COMMAND_MAILBOX__+__COMMAND_ARG0_OFFSET__) = *(unsigned int*)(0x__TASKS__+__TASK1_ID_OFFSET__)
    set *(unsigned long long*)(0x__COMMAND_MAILBOX__+__COMMAND_ARG1_OFFSET__) = 0
    set $stage = 8
  end
  continue
...
if $stage == 8
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 8
    printf "POST_TERMINATE_TASK_COUNT=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__)
    printf "POST_TERMINATE_RUNNING_SLOT=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_RUNNING_SLOT_OFFSET__)
    printf "POST_TERMINATE_LOW_RUN=%u\n", *(unsigned int*)(0x__TASKS__+__TASK0_RUN_COUNT_OFFSET__)
    printf "POST_TERMINATE_LOW_BUDGET_REMAINING=%u\n", *(unsigned int*)(0x__TASKS__+__TASK0_BUDGET_REMAINING_OFFSET__)
    printf "POST_TERMINATE_HIGH_STATE=%u\n", *(unsigned char*)(0x__TASKS__+__TASK1_STATE_OFFSET__)
    set *(unsigned short*)(0x__COMMAND_MAILBOX__+__COMMAND_OPCODE_OFFSET__) = __TASK_TERMINATE_OPCODE__
...
if $stage == 9
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 9 && *(short*)(0x__STATUS__+__STATUS_LAST_RESULT_OFFSET__) == 0 && *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__) == 3 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK0_RUN_COUNT_OFFSET__) == 2 && *(unsigned int*)(0x__TASKS__+__TASK0_BUDGET_REMAINING_OFFSET__) == 4
    printf "REPEAT_TERMINATE_RESULT=%d\n", *(short*)(0x__STATUS__+__STATUS_LAST_RESULT_OFFSET__)
    printf "REPEAT_TERMINATE_LOW_RUN=%u\n", *(unsigned int*)(0x__TASKS__+__TASK0_RUN_COUNT_OFFSET__)
    printf "REPEAT_TERMINATE_LOW_BUDGET_REMAINING=%u\n", *(unsigned int*)(0x__TASKS__+__TASK0_BUDGET_REMAINING_OFFSET__)
    set *(unsigned short*)(0x__COMMAND_MAILBOX__+__COMMAND_OPCODE_OFFSET__) = __TASK_TERMINATE_OPCODE__
...
if $stage == 10
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 10 && *(unsigned short*)(0x__STATUS__+__STATUS_LAST_OPCODE_OFFSET__) == __TASK_TERMINATE_OPCODE__ && *(short*)(0x__STATUS__+__STATUS_LAST_RESULT_OFFSET__) == 0 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__) == 0 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_RUNNING_SLOT_OFFSET__) == __SCHEDULER_NO_SLOT__ && *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__) == 3 && *(unsigned char*)(0x__TASKS__+__TASK0_STATE_OFFSET__) == __TASK_STATE_TERMINATED__
    printf "HIT_AFTER_ACTIVE_TASK_TERMINATE_PROBE\n"
...
$gdbContent = $gdbTemplate.
    ...
    Replace('__TASK_TERMINATE_OPCODE__', [string]$taskTerminateOpcode).
    ...
    Replace('__TASK_STATE_TERMINATED__', [string]$taskStateTerminated)
...
try {
    ...
    if (-not $gdbProcess.WaitForExit($TimeoutSeconds * 1000)) {
        ...
        throw "Timed out waiting for GDB active-task terminate probe"
    }
    ...
    if ($gdbExitCode -ne 0) {
        throw "GDB active-task terminate probe failed with exit code $gdbExitCode. stdout: $gdbOutput stderr: $gdbError"
    }

    foreach ($requiredMarker in @("HIT_START", "HIT_AFTER_ACTIVE_TASK_TERMINATE_PROBE")) {
    ...
    $expectations = @{
        "PRE_TERMINATE_TASK_COUNT" = 2
        "PRE_TERMINATE_RUNNING_SLOT" = 1
        "PRE_TERMINATE_LOW_RUN" = 0
        "PRE_TERMINATE_HIGH_RUN" = 1
        "PRE_TERMINATE_HIGH_BUDGET_REMAINING" = 5
        "POST_TERMINATE_TASK_COUNT" = 1
        "POST_TERMINATE_RUNNING_SLOT" = 0
        "POST_TERMINATE_LOW_RUN" = 1
        "POST_TERMINATE_LOW_BUDGET_REMAINING" = 5
        "POST_TERMINATE_HIGH_STATE" = $taskStateTerminated
        "REPEAT_TERMINATE_RESULT" = 0
        "REPEAT_TERMINATE_LOW_RUN" = 2
        "REPEAT_TERMINATE_LOW_BUDGET_REMAINING" = 4
        "ACK" = 10
        "LAST_OPCODE" = $taskTerminateOpcode
        "LAST_RESULT" = 0
        "TASK_COUNT" = 0
        "RUNNING_SLOT" = $schedulerNoSlot
        "DISPATCH_COUNT" = 3
        "LOW_ID" = 1
        "HIGH_ID" = 2
        "LOW_STATE" = $taskStateTerminated
        "HIGH_STATE" = $taskStateTerminated
        "LOW_RUN" = 2
        "HIGH_RUN" = 1
        "LOW_BUDGET_REMAINING" = 0
        "HIGH_BUDGET_REMAINING" = 0
    }
    ...
    Write-Output "BAREMETAL_GDB_BINARY=$gdb"
    Write-Output "BAREMETAL_NM_BINARY=$nm"
    Write-Output "BAREMETAL_QEMU_ACTIVE_TASK_TERMINATE_PROBE=pass"
    $gdbOutput.TrimEnd()
} finally {
