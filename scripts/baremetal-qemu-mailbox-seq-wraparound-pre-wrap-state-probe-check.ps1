...
$probeState = Invoke-WrapperProbe 
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_MAILBOX_SEQ_WRAPAROUND_PRE_WRAP_STATE_PROBE' 
    -SkippedSourceReceipt 'BAREMETAL_QEMU_MAILBOX_SEQ_WRAPAROUND_PRE_WRAP_STATE_PROBE_SOURCE' 
