...
$probeState = Invoke-WrapperProbe 
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_FEATURE_FLAGS_TICK_BATCH_INVALID_PRESERVE_PROBE' 
    -SkippedSourceReceipt 'BAREMETAL_QEMU_FEATURE_FLAGS_TICK_BATCH_INVALID_PRESERVE_PROBE_SOURCE' 
