...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_COMMAND_HEALTH_HISTORY_COMMAND_SHAPE_PROBE' 
    -SkippedSourceReceipt 'BAREMETAL_QEMU_COMMAND_HEALTH_HISTORY_COMMAND_SHAPE_PROBE_SOURCE' 
