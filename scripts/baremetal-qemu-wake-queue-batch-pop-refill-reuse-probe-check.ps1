...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_WAKE_QUEUE_BATCH_POP_REFILL_REUSE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_WAKE_QUEUE_BATCH_POP_REFILL_REUSE_PROBE_SOURCE' `
