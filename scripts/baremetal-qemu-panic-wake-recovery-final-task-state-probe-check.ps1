...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_PANIC_WAKE_RECOVERY_FINAL_TASK_STATE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_PANIC_WAKE_RECOVERY_FINAL_TASK_STATE_PROBE_SOURCE' `
