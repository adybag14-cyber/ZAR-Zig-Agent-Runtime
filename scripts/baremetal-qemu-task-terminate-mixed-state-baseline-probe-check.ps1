...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_TASK_TERMINATE_MIXED_STATE_BASELINE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_TASK_TERMINATE_MIXED_STATE_BASELINE_PROBE_SOURCE' `
