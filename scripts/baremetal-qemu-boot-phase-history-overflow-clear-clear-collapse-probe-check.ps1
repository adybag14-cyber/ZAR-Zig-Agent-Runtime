...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_BOOT_PHASE_HISTORY_OVERFLOW_CLEAR_CLEAR_COLLAPSE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_BOOT_PHASE_HISTORY_OVERFLOW_CLEAR_CLEAR_COLLAPSE_PROBE_SOURCE' `
