...
$probeState = Invoke-WrapperProbe 
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_PERIODIC_INTERRUPT_CANCEL_NO_LATE_TIMEOUT_PROBE' 
    -SkippedSourceReceipt 'BAREMETAL_QEMU_PERIODIC_INTERRUPT_CANCEL_NO_LATE_TIMEOUT_PROBE_SOURCE' 
