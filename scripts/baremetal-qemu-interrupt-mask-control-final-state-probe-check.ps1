...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_CONTROL_FINAL_STATE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_CONTROL_FINAL_STATE_PROBE_SOURCE' `
