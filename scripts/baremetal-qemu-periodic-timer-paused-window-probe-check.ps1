...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_PERIODIC_TIMER_PAUSED_WINDOW_PROBE_CHECK' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_PERIODIC_TIMER_PAUSED_WINDOW_PROBE_CHECK_SOURCE' `
