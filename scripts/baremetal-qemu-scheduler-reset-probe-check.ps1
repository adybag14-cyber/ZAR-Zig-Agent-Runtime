...
$gdbScript = Join-Path $releaseDir "qemu-scheduler-reset-probe.gdb"
$gdbStdout = Join-Path $releaseDir "qemu-scheduler-reset-probe.gdb.stdout.log"
$gdbStderr = Join-Path $releaseDir "qemu-scheduler-reset-probe.gdb.stderr.log"
$qemuStdout = Join-Path $releaseDir "qemu-scheduler-reset-probe.qemu.stdout.log"
$qemuStderr = Join-Path $releaseDir "qemu-scheduler-reset-probe.qemu.stderr.log"

$schedulerResetOpcode = 26
$schedulerEnableOpcode = 24
$taskCreateOpcode = 27

$taskBudgetBeforeReset = 5
$taskPriorityBeforeReset = 2
$taskBudgetAfterReset = 6
$taskPriorityAfterReset = 7
$schedulerNoSlot = 255
...
function Invoke-SchedulerArtifactBuildIfNeeded {
    if ($SkipBuild -and -not (Test-Path $artifact)) { throw "Scheduler reset prerequisite artifact not found at $artifact and -SkipBuild was supplied." }
    if ($SkipBuild) { return }
...
if ($null -eq $qemu) {
    ...
    Write-Output "BAREMETAL_QEMU_SCHEDULER_RESET_PROBE=skipped"
    exit 0
}
if ($null -eq $gdb) {
...
if $stage == 2
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 2
    ...
    set *(unsigned long long*)(0x__COMMAND_MAILBOX__+__COMMAND_ARG0_OFFSET__) = __TASK_BUDGET_BEFORE_RESET__
    set *(unsigned long long*)(0x__COMMAND_MAILBOX__+__COMMAND_ARG1_OFFSET__) = __TASK_PRIORITY_BEFORE_RESET__
    set $stage = 3
  end
  continue
end
if $stage == 3
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 3 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__) == 1 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK_ID_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK_RUN_COUNT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_REMAINING_OFFSET__) == 4
    printf "PRE_RESET_ENABLED=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__)
    printf "PRE_RESET_TASK_COUNT=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__)
    printf "PRE_RESET_DISPATCH_COUNT=%llu\n", *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__)
    printf "PRE_RESET_TASK0_ID=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_ID_OFFSET__)
    printf "PRE_RESET_TASK0_RUN_COUNT=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_RUN_COUNT_OFFSET__)
    printf "PRE_RESET_TASK0_BUDGET_REMAINING=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_REMAINING_OFFSET__)
    set *(unsigned short*)(0x__COMMAND_MAILBOX__+__COMMAND_OPCODE_OFFSET__) = __SCHEDULER_RESET_OPCODE__
...
if $stage == 4
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 4 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__) == 0 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__) == 0 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_RUNNING_SLOT_OFFSET__) == __SCHEDULER_NO_SLOT__ && *(unsigned int*)(0x__SCHED_STATE__+__SCHED_NEXT_TASK_ID_OFFSET__) == 1 && *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__) == 0 && *(unsigned int*)(0x__SCHED_STATE__+__SCHED_TIMESLICE_OFFSET__) == 1 && *(unsigned int*)(0x__SCHED_STATE__+__SCHED_DEFAULT_BUDGET_OFFSET__) == 8 && *(unsigned int*)(0x__TASKS__+__TASK_ID_OFFSET__) == 0
    printf "POST_RESET_ENABLED=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__)
    printf "POST_RESET_TASK_COUNT=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__)
    printf "POST_RESET_RUNNING_SLOT=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_RUNNING_SLOT_OFFSET__)
    printf "POST_RESET_NEXT_TASK_ID=%u\n", *(unsigned int*)(0x__SCHED_STATE__+__SCHED_NEXT_TASK_ID_OFFSET__)
    printf "POST_RESET_DISPATCH_COUNT=%llu\n", *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__)
    printf "POST_RESET_TIMESLICE=%u\n", *(unsigned int*)(0x__SCHED_STATE__+__SCHED_TIMESLICE_OFFSET__)
    printf "POST_RESET_DEFAULT_BUDGET=%u\n", *(unsigned int*)(0x__SCHED_STATE__+__SCHED_DEFAULT_BUDGET_OFFSET__)
    printf "POST_RESET_TASK0_ID=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_ID_OFFSET__)
    set *(unsigned short*)(0x__COMMAND_MAILBOX__+__COMMAND_OPCODE_OFFSET__) = __TASK_CREATE_OPCODE__
    set *(unsigned int*)(0x__COMMAND_MAILBOX__+__COMMAND_SEQ_OFFSET__) = 5
    set *(unsigned long long*)(0x__COMMAND_MAILBOX__+__COMMAND_ARG0_OFFSET__) = __TASK_BUDGET_AFTER_RESET__
    set *(unsigned long long*)(0x__COMMAND_MAILBOX__+__COMMAND_ARG1_OFFSET__) = __TASK_PRIORITY_AFTER_RESET__
    set $stage = 5
  end
  continue
end
if $stage == 5
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 5 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__) == 0 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK_ID_OFFSET__) == 1 && *(unsigned char*)(0x__TASKS__+__TASK_STATE_OFFSET__) == 1 && *(unsigned char*)(0x__TASKS__+__TASK_PRIORITY_OFFSET__) == __TASK_PRIORITY_AFTER_RESET__ && *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_OFFSET__) == __TASK_BUDGET_AFTER_RESET__ && *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_REMAINING_OFFSET__) == __TASK_BUDGET_AFTER_RESET__ && *(unsigned int*)(0x__TASKS__+__TASK_RUN_COUNT_OFFSET__) == 0 && *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__) == 0
    printf "POST_CREATE_ENABLED=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__)
    printf "POST_CREATE_TASK_COUNT=%u\n", *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__)
    printf "POST_CREATE_TASK0_ID=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_ID_OFFSET__)
    printf "POST_CREATE_TASK0_STATE=%u\n", *(unsigned char*)(0x__TASKS__+__TASK_STATE_OFFSET__)
    printf "POST_CREATE_TASK0_PRIORITY=%u\n", *(unsigned char*)(0x__TASKS__+__TASK_PRIORITY_OFFSET__)
    printf "POST_CREATE_TASK0_BUDGET=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_OFFSET__)
    printf "POST_CREATE_TASK0_BUDGET_REMAINING=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_REMAINING_OFFSET__)
    printf "POST_CREATE_TASK0_RUN_COUNT=%u\n", *(unsigned int*)(0x__TASKS__+__TASK_RUN_COUNT_OFFSET__)
    set *(unsigned short*)(0x__COMMAND_MAILBOX__+__COMMAND_OPCODE_OFFSET__) = __SCHEDULER_ENABLE_OPCODE__
...
if $stage == 6
  if *(unsigned int*)(0x__STATUS__+__STATUS_ACK_OFFSET__) == 6 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_ENABLED_OFFSET__) == 1 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_TASK_COUNT_OFFSET__) == 1 && *(unsigned char*)(0x__SCHED_STATE__+__SCHED_RUNNING_SLOT_OFFSET__) == 0 && *(unsigned long long*)(0x__SCHED_STATE__+__SCHED_DISPATCH_COUNT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK_ID_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK_RUN_COUNT_OFFSET__) == 1 && *(unsigned int*)(0x__TASKS__+__TASK_BUDGET_REMAINING_OFFSET__) == 5
    printf "HIT_AFTER_SCHEDULER_RESET_PROBE\n"
...
$gdbContent = $gdbTemplate.
    ...
    Replace('__TASK_BUDGET_BEFORE_RESET__', [string]$taskBudgetBeforeReset).
    Replace('__TASK_PRIORITY_BEFORE_RESET__', [string]$taskPriorityBeforeReset).
    Replace('__TASK_BUDGET_AFTER_RESET__', [string]$taskBudgetAfterReset).
    Replace('__TASK_PRIORITY_AFTER_RESET__', [string]$taskPriorityAfterReset).
    ...
    Replace('__SCHED_TIMESLICE_OFFSET__', [string]$schedulerTimesliceOffset).
    Replace('__SCHED_DEFAULT_BUDGET_OFFSET__', [string]$schedulerDefaultBudgetOffset).
    Replace('__TASK_ID_OFFSET__', [string]$taskIdOffset).
    Replace('__TASK_STATE_OFFSET__', [string]$taskStateOffset).
    Replace('__TASK_PRIORITY_OFFSET__', [string]$taskPriorityOffset).
    Replace('__TASK_RUN_COUNT_OFFSET__', [string]$taskRunCountOffset).
    Replace('__TASK_BUDGET_OFFSET__', [string]$taskBudgetOffset).
    Replace('__TASK_BUDGET_REMAINING_OFFSET__', [string]$taskBudgetRemainingOffset)
...
try {
    ...
    if (-not $gdbProcess.WaitForExit($TimeoutSeconds * 1000)) {
        ...
        throw "Timed out waiting for GDB scheduler reset probe"
    }
    ...
    if ($gdbExitCode -ne 0) {
        throw "GDB scheduler reset probe failed with exit code $gdbExitCode. stdout: $gdbOutput stderr: $gdbError"
    }

    foreach ($requiredMarker in @("HIT_START", "HIT_AFTER_SCHEDULER_RESET_PROBE")) {
    ...
    $expectations = @{
        "PRE_RESET_ENABLED" = 1
        "PRE_RESET_TASK_COUNT" = 1
        "PRE_RESET_DISPATCH_COUNT" = 1
        "PRE_RESET_TASK0_ID" = 1
        "PRE_RESET_TASK0_RUN_COUNT" = 1
        "PRE_RESET_TASK0_BUDGET_REMAINING" = 4
        "POST_RESET_ENABLED" = 0
        "POST_RESET_TASK_COUNT" = 0
        "POST_RESET_RUNNING_SLOT" = $schedulerNoSlot
        "POST_RESET_NEXT_TASK_ID" = 1
        "POST_RESET_DISPATCH_COUNT" = 0
        "POST_RESET_TIMESLICE" = 1
        "POST_RESET_DEFAULT_BUDGET" = 8
        "POST_RESET_TASK0_ID" = 0
        "POST_CREATE_ENABLED" = 0
        "POST_CREATE_TASK_COUNT" = 1
        "POST_CREATE_TASK0_ID" = 1
        "POST_CREATE_TASK0_STATE" = 1
        "POST_CREATE_TASK0_PRIORITY" = $taskPriorityAfterReset
        "POST_CREATE_TASK0_BUDGET" = $taskBudgetAfterReset
        "POST_CREATE_TASK0_BUDGET_REMAINING" = $taskBudgetAfterReset
        "POST_CREATE_TASK0_RUN_COUNT" = 0
        "ACK" = 6
        "LAST_OPCODE" = $schedulerEnableOpcode
        "LAST_RESULT" = 0
        "ENABLED" = 1
        "TASK_COUNT" = 1
        "RUNNING_SLOT" = 0
        ...
        "TASK0_ID" = 1
        "TASK0_STATE" = 1
        "TASK0_PRIORITY" = $taskPriorityAfterReset
        "TASK0_RUN_COUNT" = 1
        "TASK0_BUDGET" = $taskBudgetAfterReset
        "TASK0_BUDGET_REMAINING" = 5
    }
    ...
    if ($null -eq $ticks -or $ticks -lt 6) {
        throw "Unexpected TICKS value. Expected at least 6, got $ticks. stdout: $gdbOutput stderr: $gdbError"
    }
    ...
    Write-Output "BAREMETAL_GDB_BINARY=$gdb"
    Write-Output "BAREMETAL_NM_BINARY=$nm"
    Write-Output "BAREMETAL_QEMU_SCHEDULER_RESET_PROBE=pass"
    $gdbOutput.TrimEnd()
} finally {
