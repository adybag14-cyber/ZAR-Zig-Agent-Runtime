...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_CONTROL_UNMASK_DELIVERY_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_CONTROL_UNMASK_DELIVERY_PROBE_SOURCE' `
