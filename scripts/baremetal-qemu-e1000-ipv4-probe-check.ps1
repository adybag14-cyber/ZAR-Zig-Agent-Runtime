...
$optionsPath = Join-Path $releaseDir 'qemu-e1000-ipv4-probe-options.zig'
$rootModulePath = (Join-Path $repo "src/baremetal_main.zig").Replace('\\', '/')
$optionsModulePath = $optionsPath.Replace('\\', '/')
$mainObj = Join-Path $releaseDir 'openclaw-zig-baremetal-main-e1000-ipv4-probe.o'
$bootObj = Join-Path $releaseDir 'openclaw-zig-pvh-boot-e1000-ipv4-probe.o'
$artifact = Join-Path $releaseDir 'openclaw-zig-baremetal-pvh-e1000-ipv4-probe.elf'
...
$stdoutPath = Join-Path $releaseDir 'qemu-e1000-ipv4-probe.stdout.log'
$stderrPath = Join-Path $releaseDir 'qemu-e1000-ipv4-probe.stderr.log'
$echoStdoutPath = Join-Path $releaseDir 'qemu-e1000-ipv4-echo.stdout.log'
$echoStderrPath = Join-Path $releaseDir 'qemu-e1000-ipv4-echo.stderr.log'
...
pub const e1000_ipv4_probe: bool = true;
...
"@ | Set-Content -Path $optionsPath -Encoding Ascii
    ...
    & $zig build-obj `
        ...
        --name 'openclaw-zig-baremetal-main-e1000-ipv4-probe' `
        "-femit-bin=$mainObj"
