...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_MODE_BOOT_PHASE_HISTORY_CLEAR_MODE_COLLAPSE_PRESERVE_BOOT_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_MODE_BOOT_PHASE_HISTORY_CLEAR_MODE_COLLAPSE_PRESERVE_BOOT_PROBE_SOURCE' `
