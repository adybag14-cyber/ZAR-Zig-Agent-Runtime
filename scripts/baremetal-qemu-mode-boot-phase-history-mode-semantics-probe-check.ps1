...
if ($probeText -match '(?m)^BAREMETAL_QEMU_MODE_BOOT_PHASE_HISTORY_PROBE=skipped\r?$') {
    Write-Output 'BAREMETAL_QEMU_MODE_BOOT_PHASE_HISTORY_MODE_SEMANTICS_PROBE=skipped'
    exit 0
}
...
Write-Output 'BAREMETAL_QEMU_MODE_BOOT_PHASE_HISTORY_MODE_SEMANTICS_PROBE=pass'
Write-Output 'MODE_SEMANTIC_LEN=3'
Write-Output 'MODE_SEM0_PREV=1'
Write-Output 'MODE_SEM0_NEW=0'
Write-Output 'MODE_SEM0_REASON=1'
Write-Output 'MODE_SEM1_PREV=0'
Write-Output 'MODE_SEM1_NEW=1'
Write-Output 'MODE_SEM1_REASON=3'
Write-Output 'MODE_SEM2_PREV=1'
Write-Output 'MODE_SEM2_NEW=255'
Write-Output 'MODE_SEM2_REASON=2'
