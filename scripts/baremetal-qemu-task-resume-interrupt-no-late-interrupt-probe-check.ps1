...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_TASK_RESUME_INTERRUPT_NO_LATE_INTERRUPT_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_TASK_RESUME_INTERRUPT_NO_LATE_INTERRUPT_PROBE_SOURCE' `
