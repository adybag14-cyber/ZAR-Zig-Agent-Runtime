...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_BASELINE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_BASELINE_PROBE_SOURCE' `
...
$required = @(
    ...
    @{ Name = 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_PROBE_TASK0_STATE_AFTER_MASK'; Expected = 6; Type = 'int' },
    @{ Name = 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_PROBE_WAKE_QUEUE_COUNT_AFTER_MASK'; Expected = 0; Type = 'int' },
    @{ Name = 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_PROBE_INTERRUPT_MASK_PROFILE'; Expected = 1; Type = 'int' },
    @{ Name = 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_PROBE_INTERRUPT_MASKED_COUNT'; Expected = 224; Type = 'int' },
    @{ Name = 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_PROBE_MASKED_VECTOR_200_STATE'; Expected = 1; Type = 'int' },
    @{ Name = 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_PROBE_MASKED_VECTOR_13_STATE'; Expected = 0; Type = 'int' }
)
...
Write-Output 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_BASELINE_PROBE=pass'
Write-Output 'BAREMETAL_QEMU_INTERRUPT_MASK_EXCEPTION_BASELINE_PROBE_SOURCE=baremetal-qemu-interrupt-mask-exception-probe-check.ps1'
Write-Output 'TASK0_ID=1'
Write-Output 'TASK0_STATE_AFTER_MASK=6'
Write-Output 'WAKE_QUEUE_COUNT_AFTER_MASK=0'
Write-Output 'INTERRUPT_MASK_PROFILE=1'
Write-Output 'INTERRUPT_MASKED_COUNT=224'
Write-Output 'MASKED_VECTOR_200_STATE=1'
Write-Output 'MASKED_VECTOR_13_STATE=0'
