...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_MAILBOX_STALE_SEQ_STALE_PRESERVE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_MAILBOX_STALE_SEQ_STALE_PRESERVE_PROBE_SOURCE' `
...
Write-Output 'BAREMETAL_QEMU_MAILBOX_STALE_SEQ_STALE_PRESERVE_PROBE=pass'
Write-Output 'STALE_ACK=1'
Write-Output 'STALE_TICK_BATCH_HINT=4'
Write-Output 'STALE_MAILBOX_SEQ=1'
