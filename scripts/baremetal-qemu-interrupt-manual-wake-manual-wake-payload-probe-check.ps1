...
$probeState = Invoke-WrapperProbe 
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_INTERRUPT_MANUAL_WAKE_MANUAL_WAKE_PAYLOAD_PROBE' 
    -SkippedSourceReceipt 'BAREMETAL_QEMU_INTERRUPT_MANUAL_WAKE_MANUAL_WAKE_PAYLOAD_PROBE_SOURCE' 
