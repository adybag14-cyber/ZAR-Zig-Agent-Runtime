...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_TASK_TERMINATE_INTERRUPT_TIMEOUT_NO_STALE_TIMEOUT_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_TASK_TERMINATE_INTERRUPT_TIMEOUT_NO_STALE_TIMEOUT_PROBE_SOURCE' `
