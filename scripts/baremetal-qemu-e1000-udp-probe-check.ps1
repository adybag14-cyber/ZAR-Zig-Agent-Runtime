...
$optionsPath = Join-Path $releaseDir 'qemu-e1000-udp-probe-options.zig'
$mainObj = Join-Path $releaseDir 'openclaw-zig-baremetal-main-e1000-udp-probe.o'
$bootObj = Join-Path $releaseDir 'openclaw-zig-pvh-boot-e1000-udp-probe.o'
$artifact = Join-Path $releaseDir 'openclaw-zig-baremetal-pvh-e1000-udp-probe.elf'
...
$stdoutPath = Join-Path $releaseDir 'qemu-e1000-udp-probe.stdout.log'
$stderrPath = Join-Path $releaseDir 'qemu-e1000-udp-probe.stderr.log'
$echoStdoutPath = Join-Path $releaseDir 'qemu-e1000-udp-echo.stdout.log'
$echoStderrPath = Join-Path $releaseDir 'qemu-e1000-udp-echo.stderr.log'
...
pub const e1000_udp_probe: bool = true;
...
"@ | Set-Content -Path $optionsPath -Encoding Ascii
    ...
    & $zig build-obj `
        ...
        --name 'openclaw-zig-baremetal-main-e1000-udp-probe' `
        "-femit-bin=$mainObj"
