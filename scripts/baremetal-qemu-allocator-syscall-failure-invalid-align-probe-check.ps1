...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_ALLOCATOR_SYSCALL_FAILURE_INVALID_ALIGN_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_ALLOCATOR_SYSCALL_FAILURE_INVALID_ALIGN_PROBE_SOURCE' `
