...
$requiredSymbols = @(
    ...
    "oc_command_history_capacity",
    "oc_command_history_len",
    "oc_command_history_head_index",
    "oc_command_history_overflow_count",
    "oc_command_history_ptr",
    "oc_command_history_event",
    "oc_command_history_clear",
    "oc_health_history_capacity",
    "oc_health_history_len",
    "oc_health_history_head_index",
    "oc_health_history_overflow_count",
    "oc_health_history_ptr",
    "oc_health_history_event",
    "oc_health_history_clear",
    "oc_mode_history_capacity",
    "oc_mode_history_len",
    "oc_mode_history_head_index",
    "oc_mode_history_overflow_count",
    "oc_mode_history_ptr",
    "oc_mode_history_event",
    "oc_mode_history_clear",
    "oc_boot_phase_history_capacity",
    "oc_boot_phase_history_len",
    "oc_boot_phase_history_head_index",
    "oc_boot_phase_history_overflow_count",
    "oc_boot_phase_history_ptr",
    "oc_boot_phase_history_event",
    "oc_boot_phase_history_clear",
    "oc_command_result_counters_ptr",
    "oc_command_result_total_count",
    "oc_command_result_count_ok",
    "oc_command_result_count_invalid_argument",
    "oc_command_result_count_not_supported",
    "oc_command_result_count_other_error",
    ...
    "oc_scheduler_reset",
    "oc_allocator_state_ptr",
    "oc_allocator_page_count",
    "oc_allocator_page_bitmap_ptr",
    "oc_allocator_allocation_capacity",
    "oc_allocator_allocation_count",
    "oc_allocator_allocation",
    "oc_allocator_allocations_ptr",
    "oc_allocator_reset",
    "oc_syscall_state_ptr",
    "oc_syscall_entry_capacity",
    "oc_syscall_entry_count",
    "oc_syscall_entry",
    "oc_syscall_entries_ptr",
    "oc_syscall_enabled",
    "oc_syscall_reset",
    "oc_timer_state_ptr",
    "oc_timer_enabled",
    ...
    "oc_timer_fire_total_count",
    "oc_timer_entry",
    "oc_timer_entries_ptr",
    "oc_timer_reset",
    "oc_wake_queue_capacity",
    "oc_wake_queue_len",
    "oc_wake_queue_head_index",
    "oc_wake_queue_tail_index",
    "oc_wake_queue_overflow_count",
    "oc_wake_queue_ptr",
    "oc_wake_queue_event",
    "oc_wake_queue_pop",
    "oc_wake_queue_clear",
    ...
    "oc_interrupt_mask_ptr",
    "oc_interrupt_mask_is_set",
    "oc_interrupt_masked_count",
    "oc_interrupt_mask_ignored_count",
    "oc_interrupt_mask_profile",
    "oc_interrupt_last_masked_vector",
    "oc_interrupt_mask_ignored_vector_counts_ptr",
    "oc_interrupt_mask_ignored_vector_count",
    "oc_interrupt_mask_set",
