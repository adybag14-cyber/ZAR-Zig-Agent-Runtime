...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_ALLOCATOR_SATURATION_RESET_FRESH_RESTART_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_ALLOCATOR_SATURATION_RESET_FRESH_RESTART_PROBE_SOURCE' `
