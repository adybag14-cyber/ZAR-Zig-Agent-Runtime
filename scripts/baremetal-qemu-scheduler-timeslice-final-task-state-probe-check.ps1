...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_SCHEDULER_TIMESLICE_FINAL_TASK_STATE_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_SCHEDULER_TIMESLICE_FINAL_TASK_STATE_PROBE_SOURCE' `
