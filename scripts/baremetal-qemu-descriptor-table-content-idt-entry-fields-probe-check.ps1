...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_DESCRIPTOR_TABLE_CONTENT_IDT_ENTRY_FIELDS_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_DESCRIPTOR_TABLE_CONTENT_IDT_ENTRY_FIELDS_PROBE_SOURCE' `
