...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_TASK_TERMINATE_INTERRUPT_TIMEOUT_TARGET_CLEAR_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_TASK_TERMINATE_INTERRUPT_TIMEOUT_TARGET_CLEAR_PROBE_SOURCE' `
