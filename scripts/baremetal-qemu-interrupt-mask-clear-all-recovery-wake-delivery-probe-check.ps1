...
$probeState = Invoke-WrapperProbe `
    ...
    -SkippedReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_CLEAR_ALL_RECOVERY_WAKE_DELIVERY_PROBE' `
    -SkippedSourceReceipt 'BAREMETAL_QEMU_INTERRUPT_MASK_CLEAR_ALL_RECOVERY_WAKE_DELIVERY_PROBE_SOURCE' `
